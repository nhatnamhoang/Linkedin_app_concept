...
class AppColors {
  static var mainColor = HexColor("#1AD6E7");
  static var chatColor = HexColor("#FABA1D");
  static var tagColor = HexColor("#FBCB55");
  ...
  static var textPrimaryColor = HexColor("#A4E2ED");
